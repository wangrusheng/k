...
# Markdown LaTeX公式指导手册

> 本文由[Cmd Markdown 公式指导手册](https://www.zybuluo.com/codeep/note/163962)改写。
>
> 由于$\LaTeX$是Markdown扩展功能，各编辑器支持程度不尽相同，本文在原文的基础上语法改为支持typora。
...
- 例子：
```
$$在公式 \eqref{samp} 中，我们看到了这个被自动编号的公式。$$
$$
\begin{equation}
E=mc^2 \text{，自动编号公式示例}
\label{samp}
...
$$在公式 \eqref{11} 中，我们看到了这个被自动编号的公式。$$
$$
\begin{equation}
E=mc^2 \text{，自动编号公式示例}
\label{11}
